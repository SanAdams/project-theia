...
export default function CameraScreen() {
  ...
  const handleCapture = async () => {
    ...
    if (status !== 'granted') {
      Alert.alert('Permission required', 'Camera access is needed to scan inventory.');
      return;
    }
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>Take a photo of the boxes in the freezer</Text>
...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 15, color: '#6C6C70', marginBottom: 48, textAlign: 'center' },
  loader: { marginTop: 32 },
  primaryButton: {
